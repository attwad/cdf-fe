...
Run `npm start` and `go run server/server` for both a dev server and an API server. Navigate to `http://localhost:4200/`. The app will automatically reload if you change any of the source files.
